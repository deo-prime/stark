            ...
            setTimeout(function () {
                ...
                for (var index = 0; index < 10; index++) {
                    ...
                    if (itemIndex == 0) {
                        ...
                        + '      <header>11月骑手任务</header>'
                        + '      <div class="mid">'
                        + '        <span><label>任务类型：</label>月度任务</span> '
                        + '        <span><label>任务描述：</label>月度配送任务</span> '
                        + '        <span><label>任务佣金：</label>12000.00</span> '
                        + '        <span><label>发布时间：</label>2019年11月28日</span> '
                        + '      </div>'
                        + '      <footer><a href="#">查看明细</a></footer>'
                        + '    </hgroup>';
                    } else if (itemIndex == 1) {
                        result
                        += ''
